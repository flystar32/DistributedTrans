...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2017-4-29")
public class SimpleTransfer {
  ...
  public interface AsyncIface {
    ...
    public void transfer(String fromId, String toId, long amount, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean transfer(String fromId, String toId, long amount) throws TException
    {
      send_transfer(fromId, toId, amount);
      return recv_transfer();
    }

    public void send_transfer(String fromId, String toId, long amount) throws TException
    {
    ...
    public boolean recv_transfer() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void transfer(String fromId, String toId, long amount, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      transfer_call method_call = new transfer_call(fromId, toId, amount, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class transfer_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private String toId;
      private long amount;
      public transfer_call(String fromId, String toId, long amount, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class transfer<I extends Iface> extends org.apache.thrift.ProcessFunction<I, transfer_args> {
      ...
      public transfer_result getResult(I iface, transfer_args args) throws TException {
        transfer_result result = new transfer_result();
        result.success = iface.transfer(args.fromId, args.toId, args.amount);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class transfer<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, transfer_args, Boolean> {
      ...
      public void start(I iface, transfer_args args, AsyncMethodCallback<Boolean> resultHandler) throws TException {
        iface.transfer(args.fromId, args.toId, args.amount,resultHandler);
      }
    }
  ...
  public static class transfer_args implements org.apache.thrift.TBase<transfer_args, transfer_args._Fields>, java.io.Serializable, Cloneable, Comparable<transfer_args>   {
    ...
    public transfer_args setFromId(String fromId) {
      this.fromId = fromId;
      return this;
    }
    ...
    public transfer_args setToId(String toId) {
      this.toId = toId;
      return this;
    }
    ...
    public transfer_args setAmount(long amount) {
      this.amount = amount;
      setAmountIsSet(true);
      return this;
    }
    ...
    private static class transfer_argsStandardScheme extends StandardScheme<transfer_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, transfer_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, transfer_args struct) throws TException {
        struct.validate();
    ...
    private static class transfer_argsTupleScheme extends TupleScheme<transfer_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, transfer_args struct) throws TException {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, transfer_args struct) throws TException {
  ...
  public static class transfer_result implements org.apache.thrift.TBase<transfer_result, transfer_result._Fields>, java.io.Serializable, Cloneable, Comparable<transfer_result>   {
    ...
    private static class transfer_resultStandardScheme extends StandardScheme<transfer_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, transfer_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, transfer_result struct) throws TException {
        struct.validate();
    ...
    private static class transfer_resultTupleScheme extends TupleScheme<transfer_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, transfer_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, transfer_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
