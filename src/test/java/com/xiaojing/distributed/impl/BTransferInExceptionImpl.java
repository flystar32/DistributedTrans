...
/**
 * throw exception before B transferIn
 * use TransferOutDoJob and TransferInDoJob replace DoJob
 */
@Singleton
public class BTransferInExceptionImpl implements SimpleTransfer.Iface {
    private static final Logger LOGGER = LoggerFactory.getLogger(BTransferInExceptionImpl.class);
    ...
    public boolean transferIn(Context context, String transferId, String fromId, @SharedKey("userId") String toId, long amount) throws Exception {
        ...
        /*userDao.updateBalanceById(toId, amount, Long.MIN_VALUE);
