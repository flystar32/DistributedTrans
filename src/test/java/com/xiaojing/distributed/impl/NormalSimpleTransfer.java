 ...
 */
@Singleton
public class NormalSimpleTransfer implements SimpleTransfer.Iface {
    private static final Logger LOGGER = LoggerFactory.getLogger(NormalSimpleTransfer.class);
